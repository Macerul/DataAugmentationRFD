...
from SMOTECDNN import SMOTECDNN
import warnings
...
def main():
    ...
    for data_path in dataset_files:
        ...
        # TRAIN DATA RISULTANTI DOPO AVER APPLICATO LA SMOTE
        # Fit SMOTE on the training data
        sme = SMOTECDNN(sampling_strategy='minority', random_state=1)
        ...
        synthetic_csv_path = os.path.join(cm_dir, f"{dname}_new_tuples_SMOTECDNN.csv")
        ...
        for name, model_config in models_params.items():
            ...
            plot_confusion_matrix(
                ...
                filename=os.path.join(cm_dir, f"{name.replace(' ', '_')}_cm_{dname}_aug_gridsearch_SMOTECDNN.pdf")
            )
        ...
        results_csv = f'{dname}_classification_results_aug_gridsearch_SMOTECDNN.csv'
        ...
        params_csv = f'{dname}_best_parameters_gridsearch_SMOTECDNN.csv'
